...
<div class="container section">
    ...
    <div class="filter-section">
        <form action="{{ route('modules.index') }}" method="GET" style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap;">
            ...
            <div style="align-self: flex-end;">
                <a href="{{ route('modules.index') }}" class="btn-hero btn-hero-outline" style="padding: 10px 20px; border-radius: 10px; font-size: 0.9rem;">
                    Reset Filter
                </a>
            </div>
        </form>
    ...
    <div style="text-align: center; padding: 50px; background: var(--secondary); border-radius: 16px;">
        <i class="fas fa-folder-open" style="font-size: 4rem; color: var(--text-light); margin-bottom: 20px; opacity: 0.5;"></i>
    ...
    <div class="modules-grid">
        ...
        <div class="module-card">
            ...
            <div class="module-content">
                ...
                <button onclick="openPdfModal('{{ $module->title }}', '{{ asset('storage/' . $module->file_path) }}')" class="btn-view">
                    <i class="fas fa-eye"></i> Lihat Materi
                </button>
                <a href="{{ asset('storage/' . $module->file_path) }}" download class="btn-hero btn-hero-outline" style="width: 100%; margin-top: 10px; justify-content: center; border-radius: 8px; font-size: 0.9rem; padding: 8px;">
