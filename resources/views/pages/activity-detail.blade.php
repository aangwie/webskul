...
@section('content')
    <div class="page-header">
        <span class="activity-category"
            style="display: inline-block; padding: 8px 20px; background: rgba(255,255,255,0.2); border-radius: 20px; font-size: 0.8rem; margin-bottom: 15px;">
                    ...
                    @foreach($relatedActivities as $related)
                        <a href="{{ route('activities.show', $related->slug) }}" class="related-card">
                            ...
                            <div class="related-info">
                                <h4>{{ $related->title }}</h4>
                                <span><i class="far fa-calendar-alt"></i>
                                    {{ $related->published_at ? $related->published_at->format('d M Y') : '-' }}</span>
                            </div>
                        </a>
                    @endforeach
                </div>
