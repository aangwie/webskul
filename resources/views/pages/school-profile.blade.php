        ...
        <div class="profile-card">
            ...
            @if($school)
                <div class="profile-section">
                    ...
                    <p>{!! nl2br(e($school->vision ?? 'Menjadi sekolah unggulan yang menghasilkan lulusan berilmu, berakhlak mulia, dan berdaya saing tinggi.')) !!}
                    </p>
                </div>
                ...
                <div class="profile-section">
                    ...
                    <div>
                        {!! nl2br(e($school->mission ?? 'Menyelenggarakan pendidikan berkualitas yang mengembangkan potensi peserta didik secara optimal.')) !!}
                    </div>
                </div>

                <div class="profile-section">
                    <h2><i class="fas fa-history"></i> Sejarah</h2>
                    <p>{!! nl2br(e($school->history ?? ($school->name ?? 'SMP Negeri 6 Sudimoro') . ' didirikan dengan tekad untuk memberikan pendidikan terbaik bagi generasi muda. Sejak berdiri, sekolah ini telah menghasilkan banyak alumni yang sukses di berbagai bidang.')) !!}
                    </p>
                </div>
