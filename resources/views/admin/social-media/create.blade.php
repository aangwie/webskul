...
<div class="card">
    <div class="card-header">
        <h2>Form Tambah Media Sosial</h2>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.social-media.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="platform" class="form-input" value="{{ old('platform') }}" placeholder="Contoh: Facebook, Instagram, X" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon" class="form-input" value="{{ old('icon') }}" placeholder="Contoh: fab fa-facebook" required>
            ...
            <div class="form-group">
                ...
                <input type="url" name="url" class="form-input" value="{{ old('url') }}" placeholder="https://..." required>
