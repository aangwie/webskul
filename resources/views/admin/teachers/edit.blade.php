            ...
            <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="nip" class="form-input" value="{{ old('nip', $teacher->nip) }}"
                            maxlength="18" pattern="[0-9-]+" title="Hanya angka dan tanda hubung (-) yang diperbolehkan"
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="order" class="form-input" value="{{ old('order', $teacher->order) }}"
                            min="0">
                    </div>
                </div>
