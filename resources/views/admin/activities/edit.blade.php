        ...
        <div class="card-body">
            <form action="{{ route('admin.activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="content" id="content" value="{{ old('content', $activity->content) }}">
                    <div id="editor" style="background: var(--secondary);">{!! old('content', $activity->content) !!}</div>
